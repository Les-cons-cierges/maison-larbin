 ...
 */
final class Version20260302134039 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE requete (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, statut VARCHAR(255) NOT NULL, date_souhaitee DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, auteur_id INT NOT NULL, entreprise_id INT NOT NULL, categorie_id INT NOT NULL, assignee_id INT DEFAULT NULL, INDEX IDX_1E6639AA60BB6FE6 (auteur_id), INDEX IDX_1E6639AAA4AEAFEA (entreprise_id), INDEX IDX_1E6639AABCF5E72D (categorie_id), INDEX IDX_1E6639AA59EC7D60 (assignee_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, id_entreprise_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D6491A867E8F (id_entreprise_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
